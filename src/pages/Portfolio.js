...
<CardDeck>
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title>Google Book Search App</Card.Title>
      <Card.Text>
      An interactive web application utilizing mongoose, express, react, and node utilizing the Google Books API. Users can search and save books to a reading list if they so choose.
      </Card.Text>
    </Card.Body>
    <Card.Footer>
      <small className="text-muted">Last updated 3 mins ago</small>
